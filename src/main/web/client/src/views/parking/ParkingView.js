                   ...
                   <Row>
                     ...
                     <Col xl={{span: 12}} lg={{span: 12}} md={{span: 12}} sm={{span: 24}} xs={{span: 24}}>
                        ...
                        /><br></br><br></br><br></br>
                         ...
                         <Button type="primary" size="large" block="false" icon={"arrow-down"} loading={loading.checkIn} disabled={disableCheckIn} onClick={()=>this.addCheckIn()}>
                          Entry
                         </Button><br></br><br></br><br></br>


                         <Button type="primary"size="large" block="false" icon={"arrow-up"} loading={loading.checkOut} disabled={disableCheckOut} onClick={()=>this.addCheckOut()}>
                            Exit
                         </Button>
                     </Col>
                   </Row>
                                       ...
                                       <div >
                                          <Table  dataSource={events} pagination={pagination} >
                                                 ...
                                                 <Column title="Vehicle no." dataIndex="vehicleNo" key="vehicleNo"
                                                                ...
                                                                render={vehicleNo => (<Button onClick={()=> this.copyVehicleNo(vehicleNo)}>{vehicleNo}</Button>)}/>
                                                 <Column  title="Entry-time" dataIndex="checkIn" key="checkIn"
                                                                render={checkIn => (<div><div><Moment format="LLL">{checkIn}</Moment></div>
